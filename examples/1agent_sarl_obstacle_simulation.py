...
if __name__ == "__main__":
    ...
    config_path = "examples/configs/1agent_sarl_obstacle_simulation.yml"
    ...
    def termination_fn(orig_env_state, new_env_state):
        if orig_env_state["agent_1"] is None:
            return True, -1000 # Large negative reward for collision
        ...
        if ((a1_x - a1_goal_x) ** 2 + (a1_y - a1_goal_y) ** 2) ** 0.5 < 0.1:
            terminate = True
            reward_term = 100  # Reward for reaching the goal
